...
function App(){
  const [img, setImg] = useState (require('./assets/img/biscoito.png'));
  ...
  function quebrarBiscoito(){
    ...
    setImg(require('./assets/img/biscoitoAberto.png'));
  }

  function reiniciarTudo(){
    setTextoFrase('');
    setImg(require('./assets/img/biscoito.png'));
  }
  ...
  return(
    <View style={styles.conteiner}>
      ...
      <TouchableOpacity style={[styles.botao, {marginTop: 10, backgroundColor: 'gray'}]} onPress={ reiniciarTudo }>
        <View style={styles.bntarea}>
